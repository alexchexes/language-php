...
#  ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^ - meta.embedded.quantifier.range.regexp.php constant.character.numeric.regexp.php keyword.operator.quantifier.regexp.php
#  ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^ - punctuation.definition.quantifier.begin.regexp.php punctuation.definition.quantifier.end.regexp.php
...
// Extracted from: should let + quantify a literal opening brace in quoted regex bodies
 '/a{+1}/';
#  ^^ ^^ string.regexp.single-quoted.php
#  ^^ ^^ - meta.embedded.quantifier.range.regexp.php punctuation.definition.quantifier.begin.regexp.php punctuation.definition.quantifier.end.regexp.php
