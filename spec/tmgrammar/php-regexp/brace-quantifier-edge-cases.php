...
#  ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^ - meta.embedded.quantifier.range.regexp.php
#  ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^ - punctuation.definition.quantifier.begin.regexp.php punctuation.definition.quantifier.end.regexp.php
#  ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^ - constant.character.numeric.regexp.php keyword.operator.quantifier.regexp.php
...
#  ^^^^^ - meta.embedded.quantifier.range.regexp.php
#  ^^^^^ - punctuation.definition.quantifier.begin.regexp.php punctuation.definition.quantifier.end.regexp.php
#  ^^^^^ - keyword.operator.quantifier.regexp.php constant.character.numeric.regexp.php
