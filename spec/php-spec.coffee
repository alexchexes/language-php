  ...
  describe 'PHPDoc', ->
    ...
    describe 'types', ->
      ...
      it 'should tokenize a typed @param variable name at end-of-line in multiline phpdoc', ->
        ...
        expect(lines[1][5]).toEqual value: '$', scopes: ['source.php', 'comment.block.documentation.phpdoc.php', 'variable.other.php', 'punctuation.definition.variable.php']
        expect(lines[1][6]).toEqual value: 'foo', scopes: ['source.php', 'comment.block.documentation.phpdoc.php', 'variable.other.php']
      ...
      it 'should tokenize a typed @param variable name after union types', ->
        ...
        expect(lines[1][7]).toEqual value: '$', scopes: ['source.php', 'comment.block.documentation.phpdoc.php', 'variable.other.php', 'punctuation.definition.variable.php']
